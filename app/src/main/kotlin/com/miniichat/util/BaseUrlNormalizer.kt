...
object BaseUrlNormalizer {
    ...
    fun normalize(input: String): String {
        ...
        // DeepSeek officially accepts the host root as its OpenAI-format Base URL.
        // Keeping it intact also prevents accidental /v1/v1 duplication.
        if (host.equals("https://api.deepseek.com", ignoreCase = true) && path.isEmpty()) {
            return host
        }
