...
data class AppSettings(
    ...
    val automaticModelFallbackEnabled: Boolean = true,
...
class SettingsRepository(private val context: Context) {
    private object Keys {
        ...
        val AUTOMATIC_MODEL_FALLBACK = booleanPreferencesKey("automatic_model_fallback")
    ...
    private fun read(p: Preferences) = AppSettings(
        ...
        automaticModelFallbackEnabled = p[Keys.AUTOMATIC_MODEL_FALLBACK] ?: true,
    ...
    suspend fun update(transform: (AppSettings) -> AppSettings) {
        context.settingsDataStore.edit { p ->
            ...
            p[Keys.AUTOMATIC_MODEL_FALLBACK] = next.automaticModelFallbackEnabled
